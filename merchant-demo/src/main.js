...
<section class="automation-grid reveal"><article class="panel rule-card"><div class="panel-title"><div><span class="overline">RULE 01</span><h2>Safe reconciliation</h2><p>Automatically reconcile open incidents that have a local order and a high recovery score.</p></div><span class="rule-state">${a.enabled?"Enabled":"Disabled"}</span></div><div class="rule-row"><span>Minimum recovery score</span><b>${a.minScore ?? a.min_recovery_score ?? 75}%</b></div><div class="rule-row"><span>Allowed action</span><b>Reconcile order</b></div><div class="rule-row"><span>Charges customer</span><b>No</b></div><div class="rule-row"><span>Last automation run</span><b>${a.lastRun?time(a.lastRun):"Not yet"}</b></div></article><article class="panel guardrail"><span class="overline">GUARDRAILS</span><h2>Designed to fail safely.</h2><ul><li>${icon("check",15)} Never exposes provider secrets to the browser.</li><li>${icon("check",15)} Workspace isolation is enforced server-side.</li><li>${icon("check",15)} Payment retries are never triggered by this rule.</li><li>${icon("check",15)} Every automated action is written to the audit log.</li></ul></article></section>`;
}
